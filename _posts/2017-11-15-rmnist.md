...
more exploration using obvious techniques.

It'd also be fun to explore more radical approaches as a way of
...
possible to choose subsets of MNIST which offer significantly better
training performance?  This seems related to the problem
